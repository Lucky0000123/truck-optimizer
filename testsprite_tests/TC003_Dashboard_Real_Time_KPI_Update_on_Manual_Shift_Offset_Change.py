...
async def run_test():
    ...
    try:
        ...
        # Locate and interact with the UI element to upload or load valid Excel data.
        await page.mouse.wheel(0, window.innerHeight)
        

        # Locate the contractor shift start time offset slider UI component and adjust it.
        await page.mouse.wheel(0, window.innerHeight)
